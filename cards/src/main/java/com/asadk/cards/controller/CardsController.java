package com.asadk.cards.controller;
...
import com.asadk.cards.dto.CardsContactInfoDto;
import com.asadk.cards.dto.CardsDto;
import com.asadk.cards.dto.ErrorResponseDto;
import com.asadk.cards.dto.ResponseDto;
import com.asadk.cards.service.ICardsService;
...
@Tag(
        ...
        description = "CRUD REST APIs in a Bank to CREATE, UPDATE, FETCH AND DELETE card details"
)
public class CardsController {
	...
	public ResponseEntity<ResponseDto> createCard(@RequestParam 
		...
		cardsService.createCard(mobileNum);
	...
	public ResponseEntity<CardsDto> fetchCard(@RequestHeader("eazybank-correlation-id") String correlationId,
		...
		CardsDto cardsDto = cardsService.fetchCard(mobileNum);
