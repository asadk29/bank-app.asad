...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<ErrorResponseDto> handleCustomerAlreadyExist(CustomerAlreadyExistException ex,
		...
		errorResponse.setErrorMessgae(ex.getMessage());
	...
	public ResponseEntity<ErrorResponseDto> handleGlobalException(Exception ex, WebRequest webRequest){
	   ...
	   protected ResponseEntity<Object> handleMethodArgumentNotValid(
		   ...
		   validationErrorsList.forEach((error) -> {
			   ...
			   //casting ObjectError(parent class) into FieldError(subclass) to invoke getField()
