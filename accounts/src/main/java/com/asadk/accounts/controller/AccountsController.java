...
import com.asadk.accounts.dto.ResponseDto;
import com.asadk.accounts.service.IAccountsService;
...
@Tag(
		...
		description = "CRUD REST APIs in a Bank to CREATE, UPDATE, FETCH AND DELETE account details"
    )
public class AccountsController {
	...
	@Operation(
			...
			description = "REST API to create a new customer and account inside bank"
			)
	@ApiResponses({
        @ApiResponse(
                responseCode = "201",
        ...
        //this response is used when global exception gets thrown
        @ApiResponse(
                responseCode = "500",
	...
	@Operation(
			...
			description = "REST API to fetch existing customer and its associated account based on Mobile number"
			)
	@ApiResponses({
        @ApiResponse(
                responseCode = "200",
	...
	@GetMapping("/fetch")
	//this fetches both account and customer
	public ResponseEntity<CustomerDto> fetchAccountDetail(@RequestParam @Pattern(regexp = "(^$|[0-9]{10})", 
